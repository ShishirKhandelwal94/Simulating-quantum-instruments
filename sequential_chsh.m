...
%%%%%%%%% unital channel %%%%%%%%%
PartialTrace(x1(:,:,1)+x1(:,:,2),2)==trace(x1(:,:,1)+x1(:,:,2))*eye(2)/2;
PartialTrace(x2(:,:,1)+x2(:,:,2),2)==trace(x2(:,:,1)+x2(:,:,2))*eye(2)/2;
PartialTrace(y1(:,:,1),2)==trace(y1(:,:,1))*eye(2)/2;
PartialTrace(y1(:,:,2),2)==trace(y1(:,:,2))*eye(2)/2;
PartialTrace(y2(:,:,1),2)==trace(y2(:,:,1))*eye(2)/2;
PartialTrace(y2(:,:,2),2)==trace(y2(:,:,2))*eye(2)/2;
